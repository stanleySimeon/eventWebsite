if (typeof document !== undefined) {
  ...
  const progs = document.getElementById('mainProgram');

  progs.innerHTML = program.map((prog) => `
...
`).join('');
  ...
  const speakersContainer = document.getElementById('featuredSpeakers');
  ...
  console.log('The screen is bigger than 768px');
}
